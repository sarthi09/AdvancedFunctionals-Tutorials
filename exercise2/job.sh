...
USER_DIR="/ocean/projects/che240027p/shared/day2/$USER/exercise2"
mkdir -p $USER_DIR
...
mpirun -np $SLURM_NTASKS $qedir/bin/hp.x < CoO.hp.in > CoO.hp.out
#mpirun -np $SLURM_NTASKS $qedir/bin/pw.x < CoO.vcrelax.in > CoO.vcrelax.out
